...
<div className="flex items-center justify-end gap-3 border-t border-stone-200 px-6 py-5">

  <button
    type="button"
    onClick={onClose}
    className="rounded-lg border border-stone-300 px-5 py-2.5 text-sm font-medium text-stone-700 hover:bg-stone-100 transition"
  >
    Cancel
  </button>
  ...
  <button
    type="button"
    onClick={handleSave}
    className="rounded-lg bg-emerald-700 px-5 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800 transition"
  >
    {editingSalad ? "Update Salad" : "Create Salad"}
  </button>
